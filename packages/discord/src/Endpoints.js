...
export const WebhookMessage = (webhookId, token) => `${Webhook(webhookId, token)}/messages/@original`
...
export const InteractionMessage = (interactionId, interactionToken) => `${Interaction(interactionId, interactionToken)}/messages/@original`
